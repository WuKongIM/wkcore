...
**Tech Stack:** Go 1.23, Pebble (`github.com/cockroachdb/pebble`), `go.etcd.io/raft/v3/raftpb`, `github.com/WuKongIM/wraft/multiraft`, `github.com/WuKongIM/wraft/wkfsm`, Go testing
